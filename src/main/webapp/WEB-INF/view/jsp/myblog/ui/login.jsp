...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="<c:url value="themes/myblog/images/icon.png" />" type="image/x-icon" />
	        ...
	        <div class="g_hd_bot">
	            <div class="g_hd_bot_mn">
	                <div class="g_hd_bot_logo">
	                    <img class="g_hd_bot_logo_img" src="themes/myblog/images/logo_b.png" />
	                </div>
	                <p class="g_hd_bot_tt">隐匿者</p>
	            </div>
	        </div>
	    </header>
	        ...
	        <div class="g_ft_mn">
	            <div class="g_ft_box">
	                <div class="g_ft_edition">
	                    <p class="g_ft_edition_p">Copyright © 2016 OCCULTATOR. All Rights Reserved.</p>
	                </div>
	                <div class="g_ft_company">
	                    <p class="g_ft_company_p">技术支持：隐匿者项目组</p>
	                    <p class="g_ft_p">沪ICP备123123123号-1</p>
	                </div>
	            </div>
	           <div class="g_ft_box">
	                <div class="g_ft_rwm">
	                    <div class="g_ft_img_mn">
	                        <img class="g_ft_img" src="themes/myblog/images/close_bg_01.png" />
	                    </div>
